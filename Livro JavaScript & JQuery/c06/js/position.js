...
var cy = document.getElementById('cy'); // Elemento para armazenar clienteY

function showPosition() {   // Declara a função
    ...
    cy.value = event.clientY;   // Atualiza elemento com clientY
}
